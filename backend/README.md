...
## Project Structure
    ...
    ├── cryptofaucetlist_33384  # Django project configurations
...
1. Clone this repo and `cd cryptofaucetlist_33384`
...
2. Clone this repo and `cd cryptofaucetlist_33384`
